...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-IGSPGM_MiSTer.git"
CORE_NAME=(Arcade-IGSPGM)
...
UPSTREAM_CORE_NAME=(Arcade-IGSPGM)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-IGSPGM.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-IGSPGM.rbf)
